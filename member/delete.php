	...
	<div style="width:300px; text-align:center;">
		<form name="form_delete_m" class="form-signin" method="post" action="delete_ok.php">
			...
			<div class="row">
				...
				<div class="col-md-6" style="padding:0px 15px 0px 5px;"><input type="button" class="btn btn-lg btn-primary btn-block" value="회원탈퇴 취소" onclick="location.href='./edit.php'"></div>
			</div>
		</form>
	</div>
</div>
