...
/**********************************************/
// 총 카운트 구하기
$sql = "select count(*) from portfolio ". $where ."". $orderby .""; //가져오고자하는 목록 쿼리문 작성
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div>
			...
			?>
					<div class="gallery">
						<a href="./view.php?n_num=<?=$row['n_num']; ?>"><img src="/images/img_portfolio/<?=$row['n_file1']; ?>" width="275" height="200"></a>
