...
<form id="form_userid" name="form_userid" method="post" action="userid(2).php" onsubmit="return m1()">
	...
	<div class="col-md-4">
		<table class="table" style="border:1px solid green;">
			<thead>
				<tr>
					<th class="td_center" colspan="2"  style="font-size:20px;"><a href="/m_member/m_userid.php"  title="초기화">
					회&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;원&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;가&nbsp;&nbsp;&nbsp&nbsp;&nbsp;입</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					<td colspan="2" class="td_center"><input type="submit" value="등록"><input type="button" value="취소" onclick="/m_member/m_userid.php"></td>
				</tr>
		</table>
	</div>				
</form>
